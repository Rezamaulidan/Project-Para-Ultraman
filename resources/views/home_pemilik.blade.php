            ...
            <div class="card stat-card h-100 cursor-pointer" id="card-lunas" onclick="showList('belum-lunas', this)">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        {{-- Cek di sini: jumlahBelumLunas --}}
                        <h3 class="mb-0 fw-bold text-danger">{{ $jumlahBelumLunas }} Orang</h3>
                        {{-- Cek di sini: totalUangBelumLunas --}}
                            ...
                            <div class="list-group-item p-3 border-bottom">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('pemilik.permohonan') }}"
                                        class="btn btn-sm btn-navy rounded-pill px-3">Detail</a>
                                </div>
                            </div>
                            @empty
                            {{-- JIKA KOSONG --}}
                            ...
                            <div class="list-group-item p-3 border-bottom">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    ...
                                    <a href="https://wa.me/{{(isset($hutang->penyewa->no_hp) && substr($hutang->penyewa->no_hp, 0, 1) === '0') 
                                        ? '62' . substr($hutang->penyewa->no_hp, 1) 
                                        : ($hutang->penyewa->no_hp ?? '')}}" target="_blank"
