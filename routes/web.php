...
Route::post('/loginpenyewa', [LoginController::class, 'store']);
...
// Rute Logout (Berlaku umum atau bisa dipisah jika perlu)
Route::post('/logout', [LoginController::class, 'logout'])->name('logout');

// Rute Dashboard Penyewa (Booking Kamar)
...
})->name('pemilik.home'); // Beri nama berbeda
...
Route::get('/registrasistaff', function () {
    return view('registrasi_sfaff'); // Perbaiki nama view jika perlu
